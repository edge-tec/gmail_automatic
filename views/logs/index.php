    ...
    <div class="card-body p-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <select class="form-select form-select-sm" style="min-width: 200px;" onchange="location.href = '<?= url('/logs') ?>?<?= $selectedType ? "type={$selectedType}&" : '' ?>account_id=' + this.value">
            ...
            <table class="table table-hover align-middle mb-0" style="font-size: 0.88rem;">
                <thead class="table-light text-muted small">
                    <tr>
                        ...
                        <th>Gmail Account</th>
                        <th class="text-end" style="width: 200px;">Time (Exact)</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($log['gmail_email'])): ?>
                                <span class="badge bg-light text-dark border"><i class="fa-brands fa-google text-danger me-1"></i> <?= e($log['gmail_email']) ?></span>
                            <?php else: ?>
